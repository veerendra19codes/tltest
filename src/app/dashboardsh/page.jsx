    ...
    return (
        ...
        <div className="flex justify-center items-center flex-col w-full lg:px-2 ">
            ...
            <div className="lg:overflow-x-auto sm:w-full w-[90%] my-12 flex justify-center whitespace-nowrap bg-white rounded-xl lg:mt-2 py-4">
                <table className="Table w-[95%] h-full flex flex-col items-center justify-center sm:mt-4 whitespace-nowrap lg:overflow-x-auto border-gray-400 border-[1px]">
                    {/* <div className="flex w-full py-4 justify-center items-center whitespace-nowrap "> */}
                    <thead className="w-full">
                        {/* <tr className="w-full"> */}
                        <th className="w-1/4 py-2 text-center font-bold whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">Teamleader</th>
                        <th className="w-1/4 py-2 text-center font-bold whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">Franchise</th>
                        <th className="w-1/4 py-2  text-center font-bold  whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">Level</th>
                        <th className="w-1/4 py-2 text-center font-bold whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">Status</th>
                    ...
                    <tbody className="w-full">
                        ...
                        {sortedData.map((d) => (
                            <div key={d._id} className="w-full">
                                ...
                                <td className="w-1/4 py-2 text-center whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">{d.teamleadername}</td>


                                <td className="w-1/4 py-2 text-center whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">{d.username}</td>


                                <td className="w-1/4 py-2 text-center whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]" >{d.level}</td>

                                <td className="w-1/4 py-2 text-center whitespace-nowrap sm:w-[200px] inline-block lg:py-1 border-gray-400 border-[1px]">Free</td>
