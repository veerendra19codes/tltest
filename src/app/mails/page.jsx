            ...
            <div className="table w-4/5 h-full flex flex-col items-center justify-center gap-8">
                ...
                {data.map((d) => (
                    <div key={d.id} className="border-[1px] border-gray-500 rounded-xl w-full flex flex-row mb-8 py-4">
                        <div className="w-1/5 mx-2  pl-4  flex justify-center items-center">{d.company}</div>
                        <div className="w-1/5  mx-2 pl-4 flex justify-center items-center text-blue-500" ><a href={d.detailsurl} target="_blank" className="hover:underline">{d.details}</a></div>
                        {d.teamleader === "contact" ? (
                        ...
                        <div className={d.status === "not contacted" ? " flex w-1/5  bg-red-600 text-white rounded-xl items-center justify-center h-auto mx-2" : "w-1/5  pl-4  items-center flex justify-center h-auto mx-2"}>{d.status}</div>
                        <div className="w-1/5 mx-2  pl-4 flex justify-center items-center">{d.rejectedBy}</div>
